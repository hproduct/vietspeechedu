<template>
    ...
    <div class="d-inline-flex col-12">
        <h5 class="float-left col-7" style="padding-top: 1rem;">Danh Sách quản lý chuyên môn</h5>
    ...
    <table id="my-table" class="table table-hover table-bordered" style="margin-top: 10px;">
        ...
        <tbody>
            <tr v-for="td in entries" :key="td">
                ...
                <td>
                    <div class="d-flex">
                        <img class="small_img" :src="td.img">
...
export default {
    ...
    methods: {
        ...
        onMoveToPage(pageIndex) {
            ...
            router.push({ path: `list-supervisor`, query : { page: pageIndex } } )
        },

        getListSupervisor(pageIndex) {
            ...
            FetchApiWithCustomHeader(
                AccountAPI.GetListAccountByRoleName + `//${pageIndex}/1`, // Need to update later
                Method.GET,
                {
