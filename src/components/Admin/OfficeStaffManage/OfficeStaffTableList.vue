<template>
    ...
    <div class="d-inline-flex col-12">
        <h5 class="float-left col-7" style="padding-top: 1rem;">Danh Sách nhân viên văn phòng</h5>
...
export default {
    ...
    methods: {
        ...
        onMoveToPage(pageIndex) {
            ...
            router.push({ path: `list-office-staff`, query : { page: pageIndex } } )
        },
        ...
        getListParrentAccount(pageIndex) {
            ...
            FetchApiWithCustomHeader(
                AccountAPI.GetListAccountByRoleName + `/TEACHER/${pageIndex}/1`,
                Method.GET,
                {
